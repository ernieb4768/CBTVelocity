...
public class Activities extends Fragment{
	...
	private String[] imageURLS = {"https://scontent-ord1-1.xx.fbcdn.net/hphotos-xpt1/v/t1.0-9/11054402_746431758813274_6803565050479255580_n.jpg?oh=9fae9acb3af43fc2630a4e61d79d05de&oe=5617849A",
	...
	private void makeCards(JSONArray jsonArray){
		...
		for(int i = 0; i < jsonArray.length(); i++){
			...
			try{
				...
				description = description + object.getString("DESCRIPTION");
